...
#ifndef EicDircStandaloneUserEventInformation_h
#define EicDircStandaloneUserEventInformation_h 1

/** @TODO Review this class completely
 */
class EicDircStandaloneUserEventInformation : public G4VUserEventInformation
{
  public:

    EicDircStandaloneUserEventInformation();
    virtual ~EicDircStandaloneUserEventInformation();
